...
} from '@avara/core/domain/user/infrastructure/graphql/permission.graphql'
...
import { PaginationParamsInput } from '../../../../../../../libs/@shared/src/graphql/inputs/pagination-params.input'
